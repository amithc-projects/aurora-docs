...
menu:
  main:
    parent: "ecommerce"
    identifier: "women-aero-sprint-pro"

price: 220
ecommerce_category: "racing"
subtitle: "Women's Racing Shoes"
  ...
  <main class="l-grid" style="grid-template-columns: 1fr 400px; min-height: 800px;">
    ...
    <div style="padding: 3rem 4rem 3rem 2rem; background: var(--ds-sys-color-surface-container-lowest); border-left: 1px solid var(--ds-sys-color-border);">
      ...
      <div style="margin-bottom: 2rem;">
        <div style="font-weight: 600; color: var(--ds-sys-color-on-surface-variant); text-transform: uppercase; font-size: 0.85rem; letter-spacing: 1px; margin-bottom: 0.5rem;">Women's Racing Shoes</div>
