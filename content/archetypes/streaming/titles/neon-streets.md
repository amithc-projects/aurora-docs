...
<div data-theme="dark" style="width: 100%; min-height: 800px; border: 1px solid #333; border-radius: 8px; background: #141414; color: #ffffff; font-family: var(--ds-sys-font-family-base); display: flex; flex-direction: column;">
  ...
  <div style="width: 100%; max-width: 1200px; margin: -85px auto 4rem auto; position: relative; z-index: 10;">
    ...
    <div class="video-player" data-controls-position="overlay" data-controls-align="bottom" style="box-shadow: 0 25px 50px -12px rgba(0,0,0,0.8);">
        ...
        <video poster="/aurora-docs/images/archetypes/cyberpunk.png" data-start-time="0" preload="metadata" style="max-height: 700px; object-fit: cover; border-radius: 12px; border: 1px solid #333;">
    ...
    <div style="padding: 2rem;">
      <h1 style="font-family: 'Times New Roman', Times, serif; font-size: 3.5rem; font-weight: 900; letter-spacing: -2px; margin: 0 0 0.5rem 0;">NEON STREETS</h1>
  ...
  <div style="padding: 0 3rem 4rem 3rem;">
    ...
    <div style="margin-bottom: 3rem;">
      ...
      <div class="carousel carousel--multi" role="region" aria-label="Similar Titles">
        <div><a href="/aurora-docs/archetypes/streaming/titles/stranger-things/"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/scifi.png') center/cover; border-radius: 4px; border: 1px solid transparent; transition: border-color 0.2s;" onmouseover="this.style.borderColor='white'" onmouseout="this.style.borderColor='transparent'"></div></a></div>
        ...
        <div><a href="#"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/cyberpunk.png') center/cover; border-radius: 4px;"></div></a></div>
    ...
    <div style="margin-bottom: 0;">
      <h2 style="font-size: 1.25rem; font-weight: 700; color: #e5e5e5; margin-bottom: 1rem;">People who watched this also watched...</h2>
      <!-- Aurora Carousel Component -->
       <div class="carousel carousel--multi" role="region" aria-label="People also watched">
        <div><a href="#"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/fantasy.png') center/cover; border-radius: 4px;"></div></a></div>
        <div><a href="/aurora-docs/archetypes/streaming/titles/stranger-things/"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/horror.png') center/cover; border-radius: 4px; border: 1px solid transparent; transition: border-color 0.2s;" onmouseover="this.style.borderColor='white'" onmouseout="this.style.borderColor='transparent'"></div></a></div>
        <div><a href="#"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/scifi.png') center/cover; border-radius: 4px;"></div></a></div>
        <div><a href="#"><div style="width: 100%; height: 140px; background: url('/aurora-docs/images/archetypes/fantasy.png') center/cover; border-radius: 4px;"></div></a></div>
      </div>
    </div>
