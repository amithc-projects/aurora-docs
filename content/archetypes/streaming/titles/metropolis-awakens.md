---
title: "Metropolis Awakens"
description: "In a dystopian future, workers living underground rebel against the city's wealthy elite."
type: "streaming-title"
categories: ["Classic Cinema"]
duration: "130 min"
rating: "PG"
thumbnail: "/aurora-docs/archetypes/streaming/metropolis_awakens.jpg"
menu:
  main:
    parent: "streaming"
---
...
<div data-theme="dark" style="width: 100%; min-height: 800px; border: 1px solid #333; border-radius: 8px; background: #141414; color: #ffffff; font-family: var(--ds-sys-font-family-base); display: flex; flex-direction: column;">
  ...
  <div style="width: 100%; max-width: 1200px; margin: -85px auto 4rem auto; position: relative; z-index: 10;">
    ...
    <div class="video-player" data-controls-position="overlay" data-controls-align="bottom" style="box-shadow: 0 25px 50px -12px rgba(0,0,0,0.8);">
        <!-- Placeholder Video -->
        <video poster="/aurora-docs/archetypes/streaming/metropolis_awakens.jpg" data-start-time="0" preload="metadata" style="max-height: 700px; object-fit: cover; border-radius: 12px; border: 1px solid #333; width: 100%;">
            <source src="http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/TearsOfSteel.mp4" type="video/mp4">
        </video>
        
        <!-- Voiceover Audio -->
        <audio autoplay>
            <source src="/aurora-docs/archetypes/streaming/audio/metropolis_awakens_voiceover.mp3" type="audio/mpeg">
        </audio>
    ...
    <div style="padding: 2rem;">
      <h1 style="font-family: 'Times New Roman', Times, serif; font-size: 3.5rem; font-weight: 900; letter-spacing: -2px; margin: 0 0 0.5rem 0; text-transform: uppercase;">Metropolis Awakens</h1>
      ...
      <p style="font-size: 1.25rem; line-height: 1.5; color: #e5e5e5; max-width: 800px; margin-bottom: 2rem;">
        In a dystopian future, workers living underground rebel against the city's wealthy elite.
      </p>
